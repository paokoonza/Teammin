...
cl = LINETCR.LINE()
cl.login(token=" EoboFcoUuDGnjEovnnd3.qnC2kDs16CDREelP6lmE0W.iTeUjvWY215YtQ/44/vqCr/R7G0zYJ7JJwoVdOy0oOM=")
cl.loginResult()

#ki = LINETCR.LINE()
#ki.login(token="EoyGNr6Qc11VdtERB9Qa.erURDRo4dA04ODXJIs6PEG.BJjEIOtjYgCwkuuLvoGmd9i3dJ+1Xnvjh32QN7S1qxQ=")
#ki.loginResult()

#kk = LINETCR.LINE()
#kk.login(token="EoDuk2LnBfAqDzdlsX27.PnTQatH28FuvYSE3IGE7TW.3z09kHPUfnGiKJeB+2f/gwG1jnorn9yzVeYR0iE7+6g=")
#kk.loginResult()

#ks = LINETCR.LINE()
#ks.login(token="EoXhCXi7ypcNMgogjGfc.gornAvVQvQvNxE5OgkGQVa.78xUtE6ZrTBbCD4EObzWnuGmGBsbL5i31A1GX/Sy75s=")
#ks.loginResult()

#kc = LINETCR.LINE()
#kc.login(token="Eow92XrgokF5mEIhnfF4.wYJrjn8mz5Ran8sdCRC21a.aUsANdaMPPDTce5uMi2O97OiHiw5p2SQkusRkSnyIug=")
#kc.loginResult()

#ka = LINETCR.LINE()
#ka.login(token="Eo9Jb9Q1G87SmJDgQcg4.qkVMwfaC5ZnQ1ys7F5mN1a.tzlolxVJbd21YPxoC1WcrEUs3WNIoYPpwN/XeHEtOKA=")
#ka.loginResult()
...
║•─✯͜͡ Min Hack★BOT
╠══════════════════
╠line.me/ti/p/~socool290
╚══════════════════
"""
helpMessage2 ="""•─ ͜͡Min ᴛᴇsᴛ ʙᴏᴛ͜͡ ─•
╔═══════════════════════
╠❂➣[PROTECT: ON/OFF]:
╠❂➣[BLOCK URL: ON/OFF]:
╠❂➣[NAMELOCK: ON/OFF]:
...
admin = ["u40d73629d4b5e9c76b7842e9e8b31ed3","uf291388a1ed2cb1a0864b84a7b6106a6"]
...
admins = ["u40d73629d4b5e9c76b7842e9e8b31ed3"]
Rx5 = ["u40d73629d4b5e9c76b7842e9e8b31ed3"]
Rx4 = ["u40d73629d4b5e9c76b7842e9e8b31ed3"]
Rx3 = ["u40d73629d4b5e9c76b7842e9e8b31ed3"]
Rx2 = ["u40d73629d4b5e9c76b7842e9e8b31ed3"]
Rx1 = ["u40d73629d4b5e9c76b7842e9e8b31ed3"]
    ...
    'message':"""                 ღ¸.✻´`✻.¸¸ღ
     ╔════♪•●♥●•♪════╗
         ♝●❉•ARTHUR•❉●♝
            ∮.♪•Self★Bot•♪.∮
                 Add For me
line.me/ti/p/~art-bot-socool290
     ╚════♪•●♥●•♪════╝
Thank For Add Me
""",
    "lang":"JP",
    "comment":"Auto like By.http://line.me/ti/p/~socool290",
    "likeOn":False,
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u40d73629d4b5e9c76b7842e9e8b31ed3":
                    if "join:" in msg.text:
...
#-----------------------------------------------------------                          
				...
				OWN = "u40d73629d4b5e9c76b7842e9e8b31ed3"
				if msg.from_ in OWN:
					pass
				else:
            ...
            try:
                if op.param3 in mid:
                    ...
                    if op.param1 in protection:
                        OWN = "u40d73629d4b5e9c76b7842e9e8b31ed3","u406133ad4d3fbe50a2f4d51ea081d050","ua51ba06b0dd18c0bfe2cc6caa3458202","u34a9af3a18784280147fc413a68a77fd"
                    if op.param2 in OWN:
